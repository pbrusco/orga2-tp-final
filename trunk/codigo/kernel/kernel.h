...
/*TODO: Esta función va a ejecutarse por siempre por el kernel. Todo lo que necesita ser hecho por el kernel (con su paginacion y sus privilegios) debe ir aqui, con aquellas funciones criticas puestas entre un "cli" y un "sti" para no ser interrumpido. 
