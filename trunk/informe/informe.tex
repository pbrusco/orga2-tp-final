...
\subsection{Introducción}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item Llenar las entradas de la \textit{Directorio de Páginas} con las páginas pedidas por la tarea mediante la función \texttt{mapear\_pagina} del módulo \textbf{Paginación}.
			\item Mapear directorio \textbf{...??} mediante la función \texttt{mapear\_pagina\_default} del módulo \textbf{???}.
