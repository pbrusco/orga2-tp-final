...
\end{itemize}
			...
			\paragraph{}
				...
				\begin{itemize}
                  ...
                  \item \textbf{buscar\_entradaBCP}: devuelve la posicion en la BCP de la tarea "id". Recordar que "id" es la posicion de la entrada tss de la tarea en la gdt
                  ...
                  \item \textbf{matarTarea}: Marcar tarea como "MATAR" para que luego el KERNEL se encargue de eliminarla. El param "id" es la posicion en la GDT del segmento TSS de la tarea que se quiere eliminar.


                  \item \textbf{kill\_app}

                  
                  \item \textbf{exit}:  esta tarea se la llama cuando la tarea actual quiere terminar y llama a la interrupcion 80
                  ...
                  \item \textbf{mapeo\_paginas\_default}: mapea las paginas por default para una tarea (paginas de la gdt,idt,tss,y demas estructuras)
