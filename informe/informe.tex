...
\subsubsection{Interrupciones}
	...
	\begin{itemize}
		...
		\item \texttt{void handler\_de\_interrupciones:} Esta función es llamada por las primeras 20 rutinas de atención de interrupciones para imprimir por pantalla el número de interrupción producido y colgar la ejecución del sistema.
	\end{itemize}
