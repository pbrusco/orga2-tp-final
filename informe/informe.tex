...
\label{kernel}	
	...
	\begin{enumerate}
		...
		\item Luego, se hace una invocación a la función \texttt{iniciar\_paginacion\_kernel} del módulo \textbf{Paginación} (sección \ref{pag}) para setear e inicializar las estructuras necesarias (directorios, tablas de páginas, páginas)a fin de que el sistema pueda trabajar con este método de direccionamiento a memoria.
