...
void idtFill() {
	...
	idt[10].offset_0_15 = (unsigned short) ((unsigned int)(&_isrA) & (unsigned int) 0xFFFF); \
	idt[10].segsel = (unsigned short) 0x0008; \
	idt[10].attr = (unsigned short) 0x8E00; \
	idt[10].offset_16_31 = (unsigned short) ((unsigned int)(&_isrA) >> 16 & (unsigned int) 0xFFFF);

	idt[11].offset_0_15 = (unsigned short) ((unsigned int)(&_isrB) & (unsigned int) 0xFFFF); \
	idt[11].segsel = (unsigned short) 0x0008; \
	idt[11].attr = (unsigned short) 0x8E00; \
	idt[11].offset_16_31 = (unsigned short) ((unsigned int)(&_isrB) >> 16 & (unsigned int) 0xFFFF);

	idt[12].offset_0_15 = (unsigned short) ((unsigned int)(&_isrC) & (unsigned int) 0xFFFF); \
	idt[12].segsel = (unsigned short) 0x0008; \
	idt[12].attr = (unsigned short) 0x8E00; \
	idt[12].offset_16_31 = (unsigned short) ((unsigned int)(&_isrC) >> 16 & (unsigned int) 0xFFFF);

	idt[13].offset_0_15 = (unsigned short) ((unsigned int)(&_isrD) & (unsigned int) 0xFFFF); \
	idt[13].segsel = (unsigned short) 0x0008; \
	idt[13].attr = (unsigned short) 0x8E00; \
	idt[13].offset_16_31 = (unsigned short) ((unsigned int)(&_isrD) >> 16 & (unsigned int) 0xFFFF);
	...
	idt[15].offset_0_15 = (unsigned short) ((unsigned int)(&_isrF) & (unsigned int) 0xFFFF); \
	idt[15].segsel = (unsigned short) 0x0008; \
	idt[15].attr = (unsigned short) 0x8E00; \
	idt[15].offset_16_31 = (unsigned short) ((unsigned int)(&_isrF) >> 16 & (unsigned int) 0xFFFF);

	idt[16].offset_0_15 = (unsigned short) ((unsigned int)(&_isr10) & (unsigned int) 0xFFFF); \
	idt[16].segsel = (unsigned short) 0x0008; \
	idt[16].attr = (unsigned short) 0x8E00; \
	idt[16].offset_16_31 = (unsigned short) ((unsigned int)(&_isr10) >> 16 & (unsigned int) 0xFFFF);

	idt[17].offset_0_15 = (unsigned short) ((unsigned int)(&_isr11) & (unsigned int) 0xFFFF); \
	idt[17].segsel = (unsigned short) 0x0008; \
	idt[17].attr = (unsigned short) 0x8E00; \
	idt[17].offset_16_31 = (unsigned short) ((unsigned int)(&_isr11) >> 16 & (unsigned int) 0xFFFF);

	idt[18].offset_0_15 = (unsigned short) ((unsigned int)(&_isr12) & (unsigned int) 0xFFFF); \
	idt[18].segsel = (unsigned short) 0x0008; \
	idt[18].attr = (unsigned short) 0x8E00; \
	idt[18].offset_16_31 = (unsigned short) ((unsigned int)(&_isr12) >> 16 & (unsigned int) 0xFFFF);
